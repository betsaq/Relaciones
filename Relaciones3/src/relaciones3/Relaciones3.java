...
public class Relaciones3 {
    ...
    public static void main(String[] args) {
        ...
        BarajaService barajService = new BarajaService();
        Baraja barajaInicial = barajService.crearMazo();
        
        barajService.barajar(barajaInicial);
        barajService.mostrarBaraja(barajaInicial);
        barajService.siguienteCarta(barajaInicial);
        
        barajService.cartasDisponibles(barajaInicial);
        barajaInicial = barajService.darCartas(barajaInicial);
        barajService.cartasDisponibles(barajaInicial);
        
        barajService.cartasMonton(barajaInicial);
